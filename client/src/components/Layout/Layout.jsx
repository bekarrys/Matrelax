...
import {
  ...
  LogOut, Menu, X, ChevronLeft, ChevronRight, LayoutDashboard, Package, Plus, TrendingUp,
} from 'lucide-react';
import './Layout.css';
...
const ALL_NAV = [
  ...
  { path: '/employees',  icon: Users,           label: 'Сотрудники',  roles: ['admin'] },
  { path: '/reports',    icon: BarChart3,       label: 'Отчёты',      roles: ['admin'] },
